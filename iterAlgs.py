...
def bcredEst(dObj, rObj, 
    ...
    for indIter in range(numIter):
        ...
        gfull_robj, p = rObj.red(x, step, p, useNoise=useNoise, extend_p=None)
        ...
        for i in range(num_patch):
            ...
            if pad is None:
                g_robj, _ = rObj.red(x, step, p, useNoise=useNoise, extend_p=None)
                ...
                g_robj_patch, _ = rObj.red(padded_patch, step, p, useNoise=useNoise, extend_p=pad)
